...
public class EditCommandParser {
    ...
    public Command parse(String args) {
        ...
        ArgumentTokenizer argsTokenizer =
                new ArgumentTokenizer(PREFIX_END_DATE, PREFIX_EMAIL, PREFIX_GROUP);
        ...
        try {
            ...
            editPersonDescriptor.setDate(ParserUtil.parseDate(argsTokenizer.getValue(PREFIX_END_DATE)));
