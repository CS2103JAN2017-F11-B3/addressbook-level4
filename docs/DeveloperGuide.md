...
* can return a copy of the TaskManager
* updates task list using filters
...
4. Yesterday's Tomorrow changes the requested parameter of the task and displays the updated item to the user
Use case ends.
...
2. Yesterday's Tomorrow parses task and stores it to memory, then displays the task with formatted parameters back to user
Use case ends.
...
> 2a1. Yesterday's Tomorrow shows an error message and an example of correct formatting
...
2. Yesterday's Tomorrow display command to be undone, and undoes the command
Use case ends.
...
2. Yesterday's Tomorrow interprets the search command and displays a list of matching tasks
Use case ends.
...
> 2a1. Yesterday's Tomorrow shows an error message indicating the user's error
> Use case resumes at step 1
